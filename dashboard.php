...
<?php require_once 'db_connect.php';?>
    ...
    $sql = "SELECT * FROM `managestock`";
$query = $connect->query($sql);
$countapprove = $query->num_rows;
 $sql1 = "SELECT SUM(tprice) FROM `sale`";
$query1 = $connect->query($sql1);
$countr = $query1->num_rows;
    ?>
  <!-- ======= Header ======= -->
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Item in Stock</h5>
